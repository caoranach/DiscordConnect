...
Hooks.on("init", function() {
	...
	game.settings.register('DiscordConnect', 'ignoreWhispers', {
        name: "Ignore Whispers",
        hint: "If this is on, then it will ignore whispers. If this is off, it will send whispers to discord just like any other message.",
        scope: "world",
        config: true,
        default: true,
        type: Boolean
